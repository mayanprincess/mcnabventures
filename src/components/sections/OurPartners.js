      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="lg:hidden">
          ...
          <div className="text-center mb-[48px]">
            ...
            <h2
              ...
              style={{ fontSize: '32px', lineHeight: '38px', letterSpacing: '-1px' }}
            >
              {title}
            </h2>
          </div>
            ...
            {partners.filter((p) => p.logo).map((partner, index) => (
              <div key={index} className="flex items-center justify-center">
                <Image
                  ...
                  style={{ width: '158px', height: '41px', filter: 'brightness(0) invert(1)' }}
                />
              </div>
            ))}
          </div>
        ...
        <div className="hidden lg:flex flex-row items-center justify-between gap-8 lg:gap-12">
          ...
          <div className="flex-shrink-0 max-w-[380px]">
            ...
            {/* aria-hidden: the semantic h2 is already rendered in the mobile branch above */}
            <p
              aria-hidden="true"
              className="font-literata-light text-navy text-[28px] sm:text-[32px] lg:text-[36px] leading-snug"
            >
              {title}
            </p>
          </div>
