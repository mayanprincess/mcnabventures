    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-12 lg:mb-16">
          ...
          <p className="font-fustat-medium text-white text-lg leading-relaxed">
            {description}
          </p>
        </div>

        {/* Main Image */}
        <div className="w-[90%] max-w-[1110px] mx-auto mb-12 sm:mb-16 lg:mb-20">
          <div className="relative w-full max-h-[400px] aspect-[16/9] rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl">
            <Image
              src={image}
              alt="Team"
              fill
        ...
        {/* Stats Grid */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12 max-w-4xl mx-auto">
          {stats.map((stat, index) => (
            ...
            >
              ...
              {/* Label */}
              <span className="font-fustat-medium text-white text-lg mt-1">
                {stat.label}
              </span>
            </div>
          ))}
